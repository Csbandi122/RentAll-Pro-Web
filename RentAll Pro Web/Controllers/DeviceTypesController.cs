...
namespace RentAll_Pro_Web.Controllers
{
    public class DeviceTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TypeName")] DeviceType deviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TypeName")] DeviceType deviceType)
        {
            if (id != deviceType.Id)
            {
                return NotFound();
